      ...
      <div id="event1" ref={ref} className={animation}>
        ...
        <div id="Events" > 
                ...
                <div id="events" >
                    ...
                    <span>EVENTS</span>
                    <p className={`${css(styles.fadeInRight)}`}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quae molestiae, cum qui ullam consequatur a temporibus nesciunt commodi, eum modi minus vel eligendi sint aspernatur dolor sequi tenetur at totam?</p>
                    </div>
                </div>
        </div>
        </section>
